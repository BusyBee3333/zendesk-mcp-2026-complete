...
function App() {
  ...
  async function loadData() {
    try {
      setLoading(true);
      const result = await app.callTool('zendesk_list_automations', {});
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Automation Viewer</h1>
          <p className="text-gray-400">Browse and inspect time-based automations</p>
        </div>

        <div className="grid grid-cols-2 gap-6 mb-8">
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg">
            <div className="text-3xl font-bold mb-2">{automations.length}</div>
            <div className="text-gray-400">Total Automations</div>
          </div>
          <div className="bg-green-600 rounded-lg p-6 shadow-lg">
            <div className="text-3xl font-bold mb-2">{activeAutomations}</div>
              ...
              <div className="flex justify-between items-center mb-2">
                ...
                <div className="flex gap-2">
                  <span className={`px-3 py-1 rounded text-xs ${
                    automation.active ? 'bg-green-600' : 'bg-gray-600'
                  }`}>
        ...
        {selectedAutomation && (
          <div className="bg-gray-800 rounded-lg p-6 shadow-lg mb-8">
            <h2 className="text-2xl font-bold mb-4">Automation Details: {selectedAutomation.title}</h2>
            <div className="grid gap-4">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-2 text-gray-400">ACTIONS ({selectedAutomation.actions.length})</h3>
                <pre className="text-xs text-gray-300">
